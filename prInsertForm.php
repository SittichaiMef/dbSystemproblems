...
<body>
    <div class="container my-3">
        <h2 class="text-center">ฟอร์มบันทึกปัญหาที่เดิกจากโปรแกรม</h2>
        <form action="prInsertData.php" method="POST">
            <!-- ไม่ต้องใส่ input สำหรับ ID ที่ลำดับจะเริ่มที่ 1 โดยอัตโนมัติ -->
            <div class="form-group">
                <label for="">วันที่เกิดปัญหา</label>
                <input type="date" name="datee" id="" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="">เวลาที่เกิดปัญหา</label>
                <input type="time" name="timee" id="timee" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="">ชื่อผู้แจ้ง</label>
                <input type="text" name="nameinformer" id="timee" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="">ชื่อโปรแกรม</label>
                <input type="text" name="namepg" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="Solution" id="" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="">วันที่แก้ไขเสร็จ</label>
                <input type="date" name="datefinish" id="" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="">เวลาที่แก้ไขเสร็จ</label>
                <input type="time" name="timefinish" id="editTime" class="form-control" required >
            </div>
            <div class="form-group">
                <label for="text">ใช้เวลาแก้ไขทั้งหมด</label>
                <input type="" name="timeesm" id="edittime" class="form-control" required readonly>
            </div>
            <script>
