...
$id=$_GET["id"];
$sql="SELECT * FROM programdata WHERE id = $id";
...
<body>
    <div class="container my-3">
        <h2 class="text-center">ฟอร์มแก้ไขปัญหาที่เดิกจากโปรแกรม</h2>
        <form action="prupdatedata.php" method="POST">
            <input type="hidden" value="<?php echo $row["id"];?>" name="id">

            <div class="form-group">
                <label for="">วันที่เกิดปัญหา</label>
                <input type="date" name="datee" id="" class="form-control" value="<?php echo $row["datee"];?>">
            </div>
            <div class="form-group">
                <label for="">เวลาที่เกิดปัญหา</label>
                <input type="time" name="timee" id="timee" class="form-control" value="<?php echo $row["timee"];?>">
            </div>
            <div class="form-group">
                <label for="">ชื่อผู้แจ้ง</label>
                <input type="text" name="nameinformer" id="timee" class="form-control" value="<?php echo $row["nameinformer"];?>">
            </div>
            <div class="form-group">
                <label for="">ชื่อโปรแกรม</label>
                <input type="text" name="namepg" class="form-control" value="<?php echo $row["namepg"];?>">
            </div>
            <div class="form-group">
                <label for="">ปัญหา</label>
                <input type="text" name="problem" class="form-control" value="<?php echo $row["problem"];?>">
            </div>
            <div class="form-group">
                <label for="">สาเหตุของปัญหา</label>
                <input type="text" name="cause" class="form-control" value="<?php echo $row["cause"];?>">
            </div>
            <div class="form-group">
                <label for="">วิธีแก้ไขปัญหา</label>
                <input type="text" name="Solution" id="" class="form-control" value="<?php echo $row["Solution"];?>">
            </div>
            <div class="form-group">
                <label for="">วันที่แก้ไขเสร็จ</label>
                <input type="date" name="datefinish" id="" class="form-control" value="<?php echo $row["datefinish"];?>">
            </div>
            <div class="form-group">
                <label for="">เวลาที่แก้ไขเสร็จ</label>
                <input type="time" name="timefinish	" id="editTime" class="form-control" value="<?php echo $row["timefinish"];?>">
            </div>
            <div class="form-group">
                <label for="text">ใช้เวลาแก้ไขทั้งหมด</label>
                <input type="" name="timeesm" id="edittime" class="form-control" value="<?php echo $row["timeesm"];?>" required readonly>
            </div>
            ...
            <a href="prindex.php" class="btn btn-primary">กลับหน้าแรก</a>
        </form>
    </div>
</body>
